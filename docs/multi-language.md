...
Configure Specbase to generate artifacts in languages other than English.

## Quick Setup

Add a language instruction to your `specbase/config.yaml`:
...
specbase instructions proposal --change my-change
