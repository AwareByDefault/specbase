...
| `design` | Does the UI and copy honor the design tokens, principles, and voice? | `design-system/**` |
...
### `design` — scope: `design-system/**`
Read the affected `specs/design-system/...` pairs and the code they describe.
Judge only whether the implementation honors Does the UI and copy honor the design tokens, principles, and voice? Nothing outside its
plane (structure, style, correctness elsewhere) is yours — drop it.
