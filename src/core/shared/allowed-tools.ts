 ...
 * same field for Claude Code slash commands). Scoped to the Specbase CLI so
 * agents that honor it stop prompting on each `specbase` call; the field
 ...
 */
export const SPECBASE_CLI_ALLOWED_TOOLS = 'Bash(specbase:*)';
