...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Specbase with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Specbase.
...
5. **Submit on confirmation**
   - Use the \`specbase feedback\` command to submit
   - Format: \`specbase feedback "title" --body "body content"\`
