  ...
  describe('joinPath', () => {
    it('should join POSIX-style paths', () => {
      const result = FileSystemUtils.joinPath(
        '/tmp/project',
        '.claude/commands/specbase/proposal.md'
      );
      expect(result).toBe('/tmp/project/.claude/commands/specbase/proposal.md');
    });

    it('should join Linux home directory paths', () => {
      const result = FileSystemUtils.joinPath(
        '/home/dev/workspace/specbase',
        '.cursor/commands/install.md'
      );
      expect(result).toBe('/home/dev/workspace/specbase/.cursor/commands/install.md');
    });
    ...
    it('should join Windows drive-letter paths with backslashes', () => {
      ...
      expect(result).toBe(
        'C:\\Users\\dev\\project\\.claude\\commands\\specbase\\proposal.md'
      );
    });
    ...
    it('should join Windows paths that use forward slashes', () => {
      const result = FileSystemUtils.joinPath(
        'D:/workspace/app',
        '.cursor/commands/specbase-apply.md'
      );
      expect(result).toBe(
        'D:\\workspace\\app\\.cursor\\commands\\specbase-apply.md'
      );
    });
    ...
    it('should join UNC-style Windows paths', () => {
      const result = FileSystemUtils.joinPath(
        '\\server\\share\\repo',
        '.windsurf/workflows/specbase-archive.md'
      );
      expect(result).toBe(
        '\\server\\share\\repo\\.windsurf\\workflows\\specbase-archive.md'
      );
    });
  });
});
