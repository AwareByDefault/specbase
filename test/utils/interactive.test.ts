...
describe('interactive utilities', () => {
  let originalSpecbaseInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalSpecbaseInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalSpecbaseInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalSpecbaseInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
