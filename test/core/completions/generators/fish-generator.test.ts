  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize Specbase',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for Specbase CLI');
      expect(script).toContain('function __fish_specbase');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_specbase_using_subcommand');
      expect(script).toContain('function __fish_specbase_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c specbase");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize Specbase'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_specbase_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_specbase_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_specbase_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_specbase_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_specbase_schemas');
      expect(script).toContain('specbase __complete schemas 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_specbase_changes');
      expect(script).toContain('specbase __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_specbase_specs');
      expect(script).toContain('specbase __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_specbase_items');
      expect(script).toContain('__fish_specbase_changes');
      expect(script).toContain('__fish_specbase_specs');
    });
