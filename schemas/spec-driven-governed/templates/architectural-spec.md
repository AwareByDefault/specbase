...
<!--
  ...
  specs/architecture/<locator>/spec.md and is paired with an enforcement.yaml in
  ...
  architectural requirement to the tool through enforcement.yaml - do not embed the
