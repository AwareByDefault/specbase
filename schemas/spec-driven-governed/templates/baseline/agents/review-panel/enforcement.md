...
binding: in a consuming project the review panel is the lens set Specbase applies
...
the lenses this spec declares — e.g. Specbase itself binds `lens-conformance` to
