...
echo "======================================"
echo "Testing Specbase Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_SPECBASE_NO_COMPLETIONS="${SPECBASE_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset SPECBASE_NO_COMPLETIONS
...
echo "Test 3: SPECBASE_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export SPECBASE_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_SPECBASE_NO_COMPLETIONS" ]; then
  export SPECBASE_NO_COMPLETIONS="$ORIGINAL_SPECBASE_NO_COMPLETIONS"
else
  unset SPECBASE_NO_COMPLETIONS
fi
