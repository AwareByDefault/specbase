...
Lifecycle snapshots let installed clients inspect one Specbase work item through a stable, headless contract that agrees with Specbase's own status surface.
