...
The action boundary centralizes Specbase lifecycle policy and exact-intent validation while giving external clients only typed descriptors they can route through separately owned execution systems.
