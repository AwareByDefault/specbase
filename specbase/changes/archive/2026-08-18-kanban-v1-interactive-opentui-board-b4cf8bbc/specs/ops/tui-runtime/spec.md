...
Define the supported runtime and packaging contract for initializing the interactive terminal renderer without changing non-interactive CLI requirements.
