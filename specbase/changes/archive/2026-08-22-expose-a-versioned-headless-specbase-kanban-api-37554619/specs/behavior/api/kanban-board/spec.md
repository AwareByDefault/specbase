...
The headless kanban API gives installed clients a stable project-wide snapshot they can validate and render independently of Specbase's CLI and terminal viewer.
