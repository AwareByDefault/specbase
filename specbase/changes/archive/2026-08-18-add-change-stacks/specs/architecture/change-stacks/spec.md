...
## Purpose
Change-stack structure keeps delivery order and projected truth deterministic without coupling ordinary work items to Git topology, cross-repository planning, or duplicated lifecycle state.
