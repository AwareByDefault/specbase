...
## Purpose
Change stacks let users deliver a large intent as an ordered sequence of independently observable and reviewable changes while preserving the ordinary lifecycle and evidence of every slice.
